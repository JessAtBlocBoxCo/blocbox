...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.transtype'
        db.delete_column(u'core_transaction', 'transtype')

        # Adding field 'Transaction.favortype'
        db.add_column(u'core_transaction', 'favortype',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Transaction.date_requested'
        db.alter_column(u'core_transaction', 'date_requested', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Transaction.price'
        db.alter_column(u'core_transaction', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

    def backwards(self, orm):
        # Adding field 'Transaction.transtype'
        db.add_column(u'core_transaction', 'transtype',
                      self.gf('django.db.models.fields.CharField')(default='Package', max_length=30),
                      keep_default=False)

        # Deleting field 'Transaction.favortype'
        db.delete_column(u'core_transaction', 'favortype')


        # Changing field 'Transaction.date_requested'
        db.alter_column(u'core_transaction', 'date_requested', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Transaction.price'
        db.alter_column(u'core_transaction', 'price', self.gf('django.db.models.fields.DecimalField')(default=2.0, max_digits=6, decimal_places=2))
    ...
    models = {
        ...
        u'core.transaction': {
            ...
            'enduser': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'payee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payee'", 'to': u"orm['core.UserInfo']"}),
            'payer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payer'", 'to': u"orm['core.UserInfo']"}),
