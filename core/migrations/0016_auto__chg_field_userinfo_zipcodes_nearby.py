...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserInfo.zipcodes_nearby'
        db.alter_column(u'core_userinfo', 'zipcodes_nearby', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'UserInfo.zipcodes_nearby'
        db.alter_column(u'core_userinfo', 'zipcodes_nearby', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
