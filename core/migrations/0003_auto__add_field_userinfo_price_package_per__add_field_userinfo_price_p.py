...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.price_package_per'
        db.add_column(u'core_userinfo', 'price_package_per',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.price_package_bundle10'
        db.add_column(u'core_userinfo', 'price_package_bundle10',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.price_package_month20'
        db.add_column(u'core_userinfo', 'price_package_month20',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.price_package_annual'
        db.add_column(u'core_userinfo', 'price_package_annual',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.price_package_per'
        db.delete_column(u'core_userinfo', 'price_package_per')

        # Deleting field 'UserInfo.price_package_bundle10'
        db.delete_column(u'core_userinfo', 'price_package_bundle10')

        # Deleting field 'UserInfo.price_package_month20'
        db.delete_column(u'core_userinfo', 'price_package_month20')

        # Deleting field 'UserInfo.price_package_annual'
        db.delete_column(u'core_userinfo', 'price_package_annual')
