...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.customchartwo'
        db.add_column(u'core_userinfo', 'customchartwo',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.customchartwo'
        db.delete_column(u'core_userinfo', 'customchartwo')
