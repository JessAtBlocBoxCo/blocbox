...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_transaction', 'invoice',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Transaction.payer'
        db.alter_column(u'core_transaction', 'payer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.UserInfo']))

        # Changing field 'Transaction.payee'
        db.alter_column(u'core_transaction', 'payee_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.UserInfo']))

    def backwards(self, orm):
        # Deleting field 'Transaction.invoice'
        db.delete_column(u'core_transaction', 'invoice')


        # Changing field 'Transaction.payer'
        db.alter_column(u'core_transaction', 'payer_id', self.gf('django.db.models.fields.related.ForeignKey')(default='testpayer', to=orm['core.UserInfo']))

        # Changing field 'Transaction.payee'
        db.alter_column(u'core_transaction', 'payee_id', self.gf('django.db.models.fields.related.ForeignKey')(default='testpayee', to=orm['core.UserInfo']))
    ...
    models = {
        ...
        u'core.transaction': {
            ...
            'payee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'payee'", 'null': 'True', 'to': u"orm['core.UserInfo']"}),
            'payer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'payer'", 'null': 'True', 'to': u"orm['core.UserInfo']"}),
