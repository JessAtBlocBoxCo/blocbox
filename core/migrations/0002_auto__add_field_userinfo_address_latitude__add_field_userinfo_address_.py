...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.address_latitude'
        db.add_column(u'core_userinfo', 'address_latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.address_longitude'
        db.add_column(u'core_userinfo', 'address_longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.address_latitude'
        db.delete_column(u'core_userinfo', 'address_latitude')

        # Deleting field 'UserInfo.address_longitude'
        db.delete_column(u'core_userinfo', 'address_longitude')
