...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_transaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payer', to=orm['core.UserInfo'])),
            ('payee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payee', to=orm['core.UserInfo'])),
            ('transtype', self.gf('django.db.models.fields.CharField')(default='Package', max_length=30)),
            ...
            ('date_payed', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'core', ['Transaction'])

        # Adding model 'Connection'
        db.create_table(u'core_connection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='host_id', to=orm['core.UserInfo'])),
            ('end_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='enduser_id', to=orm['core.UserInfo'])),
            ('added', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
        ))
        db.send_create_signal(u'core', ['Connection'])

        # Adding unique constraint on 'Connection', fields ['host_user', 'end_user']
        db.create_unique(u'core_connection', ['host_user_id', 'end_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Connection', fields ['host_user', 'end_user']
        db.delete_unique(u'core_connection', ['host_user_id', 'end_user_id'])
        ...
        db.delete_table(u'core_connection')
    ...
    models = {
        ...
        u'core.transaction': {
            ...
            'date_payed': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'transtype': ('django.db.models.fields.CharField', [], {'default': "'Package'", 'max_length': '30'})
        },
        u'core.userinfo': {
