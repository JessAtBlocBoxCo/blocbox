...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_userinfo', (
            ...
            ('neighbors', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ...
            ('currentlyhelping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
    ...
    models = {
        ...
        u'core.userinfo': {
            ...
            'neighbors': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
