...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.facebook_locale'
        db.add_column(u'core_userinfo', 'facebook_locale',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.facebook_locale'
        db.delete_column(u'core_userinfo', 'facebook_locale')
