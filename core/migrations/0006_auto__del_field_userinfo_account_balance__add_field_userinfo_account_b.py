...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserInfo.account_balance'
        db.delete_column(u'core_userinfo', 'account_balance')

        # Adding field 'UserInfo.account_balance_packages'
        db.add_column(u'core_userinfo', 'account_balance_packages',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserInfo.account_balance'
        db.add_column(u'core_userinfo', 'account_balance',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)

        # Deleting field 'UserInfo.account_balance_packages'
        db.delete_column(u'core_userinfo', 'account_balance_packages')
