...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.neighborhood_extended'
        db.add_column(u'core_userinfo', 'neighborhood_extended',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.neighborhood_extended'
        db.delete_column(u'core_userinfo', 'neighborhood_extended')
    ...
    models = {
        u'core.userinfo': {
            ...
            'Referrals_from_user_waitlist': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'neighborhood_extended': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
