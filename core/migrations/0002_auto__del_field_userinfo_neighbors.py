...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserInfo.neighbors'
        db.delete_column(u'core_userinfo', 'neighbors')

        # Adding M2M table for field neighbors on 'UserInfo'
        m2m_table_name = db.shorten_name(u'core_userinfo_neighbors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userinfo', models.ForeignKey(orm[u'core.userinfo'], null=False)),
            ('to_userinfo', models.ForeignKey(orm[u'core.userinfo'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_userinfo_id', 'to_userinfo_id'])


    def backwards(self, orm):
        # Adding field 'UserInfo.neighbors'
        db.add_column(u'core_userinfo', 'neighbors',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field neighbors on 'UserInfo'
        db.delete_table(db.shorten_name(u'core_userinfo_neighbors'))
    ...
    models = {
        ...
        u'core.userinfo': {
            ...
            'currentlyhelping': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'neighbors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'neighbors_rel_+'", 'to': u"orm['core.UserInfo']"}),
