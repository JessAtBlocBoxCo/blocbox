...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.profile_pic_uploaded'
        db.add_column(u'core_userinfo', 'profile_pic_uploaded',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.profile_pic_uploaded'
        db.delete_column(u'core_userinfo', 'profile_pic_uploaded')
