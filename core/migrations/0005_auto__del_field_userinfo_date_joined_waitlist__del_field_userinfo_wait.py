...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserInfo.waitlistuser'
        db.delete_column(u'core_userinfo', 'waitlistuser')

        # Deleting field 'UserInfo.fulluser'
        db.delete_column(u'core_userinfo', 'fulluser')

        # Deleting field 'UserInfo.waitlist_referred_by'
        db.delete_column(u'core_userinfo', 'waitlist_referred_by')

        # Adding field 'UserInfo.Referrals_from_user'
        db.add_column(u'core_userinfo', 'Referrals_from_user',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserInfo.waitlistuser'
        db.add_column(u'core_userinfo', 'waitlistuser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserInfo.fulluser'
        db.add_column(u'core_userinfo', 'fulluser',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserInfo.waitlist_referred_by'
        db.add_column(u'core_userinfo', 'waitlist_referred_by',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserInfo.Referrals_from_user'
        db.delete_column(u'core_userinfo', 'Referrals_from_user')
    ...
    models = {
        u'core.userinfo': {
            ...
            'Referrals_from_user': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
