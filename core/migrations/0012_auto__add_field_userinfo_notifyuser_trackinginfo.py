...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.notifyuser_trackinginfo'
        db.add_column(u'core_userinfo', 'notifyuser_trackinginfo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.notifyuser_trackinginfo'
        db.delete_column(u'core_userinfo', 'notifyuser_trackinginfo')
