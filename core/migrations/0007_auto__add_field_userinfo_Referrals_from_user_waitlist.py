...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.Referrals_from_user_waitlist'
        db.add_column(u'core_userinfo', 'Referrals_from_user_waitlist',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.Referrals_from_user_waitlist'
        db.delete_column(u'core_userinfo', 'Referrals_from_user_waitlist')
