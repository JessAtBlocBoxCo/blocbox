...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.tracking'
        db.add_column(u'core_transaction', 'tracking',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.shipmentstatus'
        db.add_column(u'core_transaction', 'shipmentstatus',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.deliverydate'
        db.add_column(u'core_transaction', 'deliverydate',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.favorstatus'
        db.add_column(u'core_transaction', 'favorstatus',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.tracking'
        db.delete_column(u'core_transaction', 'tracking')

        # Deleting field 'Transaction.shipmentstatus'
        db.delete_column(u'core_transaction', 'shipmentstatus')

        # Deleting field 'Transaction.deliverydate'
        db.delete_column(u'core_transaction', 'deliverydate')

        # Deleting field 'Transaction.favorstatus'
        db.delete_column(u'core_transaction', 'favorstatus')
