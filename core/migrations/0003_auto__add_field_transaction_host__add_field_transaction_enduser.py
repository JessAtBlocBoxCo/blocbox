...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_transaction', 'host',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.enduser'
        db.add_column(u'core_transaction', 'enduser',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_transaction', 'host')

        # Deleting field 'Transaction.enduser'
        db.delete_column(u'core_transaction', 'enduser')
