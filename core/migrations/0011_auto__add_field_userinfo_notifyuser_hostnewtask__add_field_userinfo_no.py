...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.notifyuser_hostnewtask'
        db.add_column(u'core_userinfo', 'notifyuser_hostnewtask',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserInfo.notifyuser_message'
        db.add_column(u'core_userinfo', 'notifyuser_message',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserInfo.notifyuser_packageships'
        db.add_column(u'core_userinfo', 'notifyuser_packageships',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserInfo.notifyuser_packageissue'
        db.add_column(u'core_userinfo', 'notifyuser_packageissue',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserInfo.notifyuser_packagereceived'
        db.add_column(u'core_userinfo', 'notifyuser_packagereceived',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserInfo.notifyuser_blocboxnews'
        db.add_column(u'core_userinfo', 'notifyuser_blocboxnews',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.notifyuser_hostnewtask'
        db.delete_column(u'core_userinfo', 'notifyuser_hostnewtask')

        # Deleting field 'UserInfo.notifyuser_message'
        db.delete_column(u'core_userinfo', 'notifyuser_message')

        # Deleting field 'UserInfo.notifyuser_packageships'
        db.delete_column(u'core_userinfo', 'notifyuser_packageships')

        # Deleting field 'UserInfo.notifyuser_packageissue'
        db.delete_column(u'core_userinfo', 'notifyuser_packageissue')

        # Deleting field 'UserInfo.notifyuser_packagereceived'
        db.delete_column(u'core_userinfo', 'notifyuser_packagereceived')

        # Deleting field 'UserInfo.notifyuser_blocboxnews'
        db.delete_column(u'core_userinfo', 'notifyuser_blocboxnews')
    ...
    models = {
        u'core.userinfo': {
            ...
            'notifyuser_packageissue': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
