...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.facebook_email'
        db.add_column(u'core_userinfo', 'facebook_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=254, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_gender'
        db.add_column(u'core_userinfo', 'facebook_gender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_link'
        db.add_column(u'core_userinfo', 'facebook_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_verified'
        db.add_column(u'core_userinfo', 'facebook_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_first_name'
        db.add_column(u'core_userinfo', 'facebook_first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_last_name'
        db.add_column(u'core_userinfo', 'facebook_last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'UserInfo.facebook_response_all'
        db.add_column(u'core_userinfo', 'facebook_response_all',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.facebook_email'
        db.delete_column(u'core_userinfo', 'facebook_email')

        # Deleting field 'UserInfo.facebook_gender'
        db.delete_column(u'core_userinfo', 'facebook_gender')

        # Deleting field 'UserInfo.facebook_link'
        db.delete_column(u'core_userinfo', 'facebook_link')

        # Deleting field 'UserInfo.facebook_verified'
        db.delete_column(u'core_userinfo', 'facebook_verified')

        # Deleting field 'UserInfo.facebook_first_name'
        db.delete_column(u'core_userinfo', 'facebook_first_name')

        # Deleting field 'UserInfo.facebook_last_name'
        db.delete_column(u'core_userinfo', 'facebook_last_name')

        # Deleting field 'UserInfo.facebook_response_all'
        db.delete_column(u'core_userinfo', 'facebook_response_all')
