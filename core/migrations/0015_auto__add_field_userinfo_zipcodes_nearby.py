...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserInfo.zipcodes_nearby'
        db.add_column(u'core_userinfo', 'zipcodes_nearby',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserInfo.zipcodes_nearby'
        db.delete_column(u'core_userinfo', 'zipcodes_nearby')
    ...
    models = {
        u'core.userinfo': {
            ...
            'zipcodes_nearby': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        }
    }
