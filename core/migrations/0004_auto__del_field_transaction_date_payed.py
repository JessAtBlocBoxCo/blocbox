...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.date_payed'
        db.delete_column(u'core_transaction', 'date_payed')


    def backwards(self, orm):
        # Adding field 'Transaction.date_payed'
        db.add_column(u'core_transaction', 'date_payed',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 9, 0, 0)),
                      keep_default=False)
