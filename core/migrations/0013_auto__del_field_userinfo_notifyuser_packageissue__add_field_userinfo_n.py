...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.notifyuser_deliveryexception'
        db.add_column(u'core_userinfo', 'notifyuser_deliveryexception',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserInfo.notifyuser_deliveryexception'
        db.delete_column(u'core_userinfo', 'notifyuser_deliveryexception')
