...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.payer'
        db.delete_column(u'core_transaction', 'payer_id')

        # Deleting field 'Transaction.payee'
        db.delete_column(u'core_transaction', 'payee_id')


        # Renaming column for 'Transaction.enduser' to match new field type.
        db.rename_column(u'core_transaction', 'enduser', 'enduser_id')
        # Changing field 'Transaction.enduser'
        db.alter_column(u'core_transaction', 'enduser_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.UserInfo']))
        # Adding index on 'Transaction', fields ['enduser']
        db.create_index(u'core_transaction', ['enduser_id'])


        # Renaming column for 'Transaction.host' to match new field type.
        db.rename_column(u'core_transaction', 'host', 'host_id')
        # Changing field 'Transaction.host'
        db.alter_column(u'core_transaction', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.UserInfo']))
        # Adding index on 'Transaction', fields ['host']
        db.create_index(u'core_transaction', ['host_id'])


    def backwards(self, orm):
        # Removing index on 'Transaction', fields ['host']
        db.delete_index(u'core_transaction', ['host_id'])

        # Removing index on 'Transaction', fields ['enduser']
        db.delete_index(u'core_transaction', ['enduser_id'])

        # Adding field 'Transaction.payer'
        db.add_column(u'core_transaction', 'payer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='payer', null=True, to=orm['core.UserInfo'], blank=True),
                      keep_default=False)

        # Adding field 'Transaction.payee'
        db.add_column(u'core_transaction', 'payee',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='payee', null=True, to=orm['core.UserInfo'], blank=True),
                      keep_default=False)


        # Renaming column for 'Transaction.enduser' to match new field type.
        db.rename_column(u'core_transaction', 'enduser_id', 'enduser')
        # Changing field 'Transaction.enduser'
        db.alter_column(u'core_transaction', 'enduser', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Renaming column for 'Transaction.host' to match new field type.
        db.rename_column(u'core_transaction', 'host_id', 'host')
        # Changing field 'Transaction.host'
        db.alter_column(u'core_transaction', 'host', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'core.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
