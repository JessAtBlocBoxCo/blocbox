...
urlpatterns = patterns('',
    ...
    url(r'^startashipment/host(?P<host_id>\d+)/cal_form_submitted(?P<cal_form_submitted>\w+)/invoice(?P<invoice>\w+)/$', 'transactions.views.startashipment', name='startashipmentdays'),
