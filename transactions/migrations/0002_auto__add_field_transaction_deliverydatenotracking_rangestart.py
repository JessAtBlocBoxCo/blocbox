...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.deliverydatenotracking_rangestart'
        db.add_column(u'transactions_transaction', 'deliverydatenotracking_rangestart',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.deliverydatenotracking_rangestart'
        db.delete_column(u'transactions_transaction', 'deliverydatenotracking_rangestart')
