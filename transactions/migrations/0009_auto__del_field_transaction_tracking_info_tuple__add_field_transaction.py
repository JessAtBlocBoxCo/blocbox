...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.tracking_info_tuple'
        db.delete_column(u'transactions_transaction', 'tracking_info_tuple')

        # Adding field 'Transaction.tracking_info_tuple_inital'
        db.add_column(u'transactions_transaction', 'tracking_info_tuple_inital',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.shipment_type'
        db.add_column(u'transactions_transaction', 'shipment_type',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.tracking_info_tuple_confirmd'
        db.add_column(u'transactions_transaction', 'tracking_info_tuple_confirmd',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Transaction.tracking_info_tuple'
        db.add_column(u'transactions_transaction', 'tracking_info_tuple',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Transaction.tracking_info_tuple_inital'
        db.delete_column(u'transactions_transaction', 'tracking_info_tuple_inital')

        # Deleting field 'Transaction.shipment_type'
        db.delete_column(u'transactions_transaction', 'shipment_type')

        # Deleting field 'Transaction.tracking_info_tuple_confirmd'
        db.delete_column(u'transactions_transaction', 'tracking_info_tuple_confirmd')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 13, 0, 0)'}),
            ...
            'expected_delivery': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'shipment_type': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            ...
            'tracking_info_tuple_inital': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
