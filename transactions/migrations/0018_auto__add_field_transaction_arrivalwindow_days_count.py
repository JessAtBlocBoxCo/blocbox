...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.arrivalwindow_days_count'
        db.add_column(u'transactions_transaction', 'arrivalwindow_days_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.arrivalwindow_days_count'
        db.delete_column(u'transactions_transaction', 'arrivalwindow_days_count')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 2, 0, 0)'}),
