...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.date_requested_notime'
        db.add_column(u'transactions_transaction', 'date_requested_notime',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.date_requested_notime'
        db.delete_column(u'transactions_transaction', 'date_requested_notime')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested_notime': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today'}),
