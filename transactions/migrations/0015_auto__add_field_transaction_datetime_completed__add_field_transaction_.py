...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.datetime_completed'
        db.add_column(u'transactions_transaction', 'datetime_completed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.date_completed'
        db.add_column(u'transactions_transaction', 'date_completed',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.datetime_completed'
        db.delete_column(u'transactions_transaction', 'datetime_completed')

        # Deleting field 'Transaction.date_completed'
        db.delete_column(u'transactions_transaction', 'date_completed')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 14, 0, 0)'}),
