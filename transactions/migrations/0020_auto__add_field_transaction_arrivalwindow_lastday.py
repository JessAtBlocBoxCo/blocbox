...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.arrivalwindow_lastday'
        db.add_column(u'transactions_transaction', 'arrivalwindow_lastday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.arrivalwindow_lastday'
        db.delete_column(u'transactions_transaction', 'arrivalwindow_lastday')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 13, 0, 0)'}),
