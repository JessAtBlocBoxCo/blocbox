...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.arrivalwindow_string'
        db.add_column(u'transactions_transaction', 'arrivalwindow_string',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.arrivalwindow_string'
        db.delete_column(u'transactions_transaction', 'arrivalwindow_string')
