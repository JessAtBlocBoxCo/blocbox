...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.date_requested_notime'
        db.alter_column(u'transactions_transaction', 'date_requested_notime', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.date_requested_notime'
        db.alter_column(u'transactions_transaction', 'date_requested_notime', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 10, 0, 0)'}),
            'date_requested_notime': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today', 'null': 'True', 'blank': 'True'}),
