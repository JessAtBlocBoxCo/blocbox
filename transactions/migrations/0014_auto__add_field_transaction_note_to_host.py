...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.note_to_host'
        db.add_column(u'transactions_transaction', 'note_to_host',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.note_to_host'
        db.delete_column(u'transactions_transaction', 'note_to_host')
