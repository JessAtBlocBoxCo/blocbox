...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.deliverydatenotracking_rangeend'
        db.add_column(u'transactions_transaction', 'deliverydatenotracking_rangeend',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.deliverydate_tracking'
        db.add_column(u'transactions_transaction', 'deliverydate_tracking',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.deliverydatenotracking_rangeend'
        db.delete_column(u'transactions_transaction', 'deliverydatenotracking_rangeend')

        # Deleting field 'Transaction.deliverydate_tracking'
        db.delete_column(u'transactions_transaction', 'deliverydate_tracking')
