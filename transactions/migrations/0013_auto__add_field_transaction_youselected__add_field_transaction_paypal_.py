...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.youselected'
        db.add_column(u'transactions_transaction', 'youselected',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.paypal_quantity'
        db.add_column(u'transactions_transaction', 'paypal_quantity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.youselected'
        db.delete_column(u'transactions_transaction', 'youselected')

        # Deleting field 'Transaction.paypal_quantity'
        db.delete_column(u'transactions_transaction', 'paypal_quantity')
