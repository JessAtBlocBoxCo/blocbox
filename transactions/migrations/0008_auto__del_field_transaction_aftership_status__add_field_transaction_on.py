...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.on_aftership'
        db.add_column(u'transactions_transaction', 'on_aftership',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Transaction.on_aftership'
        db.delete_column(u'transactions_transaction', 'on_aftership')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'tracking_info_tuple': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
