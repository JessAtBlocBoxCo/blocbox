...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.payment_processed'
        db.add_column(u'transactions_transaction', 'payment_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.payment_processed'
        db.delete_column(u'transactions_transaction', 'payment_processed')
