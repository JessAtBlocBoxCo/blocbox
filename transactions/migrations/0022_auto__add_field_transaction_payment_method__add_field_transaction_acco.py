...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.payment_method'
        db.add_column(u'transactions_transaction', 'payment_method',
    ...
    def backwards(self, orm):
        # Deleting field 'Transaction.payment_method'
        db.delete_column(u'transactions_transaction', 'payment_method')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 14, 0, 0)'}),
