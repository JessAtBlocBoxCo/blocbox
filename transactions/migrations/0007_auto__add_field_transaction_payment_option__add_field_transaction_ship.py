...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.payment_option'
        db.add_column(u'transactions_transaction', 'payment_option',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.shipment_courier'
        db.add_column(u'transactions_transaction', 'shipment_courier',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.expected_delivery'
        db.add_column(u'transactions_transaction', 'expected_delivery',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Transaction.aftership_status'
        db.add_column(u'transactions_transaction', 'aftership_status',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.payment_option'
        db.delete_column(u'transactions_transaction', 'payment_option')

        # Deleting field 'Transaction.shipment_courier'
        db.delete_column(u'transactions_transaction', 'shipment_courier')

        # Deleting field 'Transaction.expected_delivery'
        db.delete_column(u'transactions_transaction', 'expected_delivery')

        # Deleting field 'Transaction.aftership_status'
        db.delete_column(u'transactions_transaction', 'aftership_status')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'aftership_status': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 12, 0, 0)'}),
