...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.amount_due'
        db.add_column(u'transactions_transaction', 'amount_due',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.amount_due'
        db.delete_column(u'transactions_transaction', 'amount_due')
