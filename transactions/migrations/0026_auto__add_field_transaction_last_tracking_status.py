...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.last_tracking_status'
        db.add_column(u'transactions_transaction', 'last_tracking_status',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.last_tracking_status'
        db.delete_column(u'transactions_transaction', 'last_tracking_status')
    ...
    models = {
        ...
        u'transactions.transaction': {
            ...
            'date_requested': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 8, 0, 0)'}),
            ...
            'last_tracking_status': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
