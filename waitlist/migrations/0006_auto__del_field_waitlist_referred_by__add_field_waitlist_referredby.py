...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Waitlist.referred_by'
        db.delete_column(u'waitlist_waitlist', 'referred_by')

        # Adding field 'Waitlist.referredby'
        db.add_column(u'waitlist_waitlist', 'referredby',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Waitlist.referred_by'
        db.add_column(u'waitlist_waitlist', 'referred_by',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Waitlist.referredby'
        db.delete_column(u'waitlist_waitlist', 'referredby')
