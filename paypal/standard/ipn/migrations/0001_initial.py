    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom', models.CharField(max_length=255, verbose_name=b'User Email', blank=True)),
                ('host_email', models.CharField(max_length=255, verbose_name=b'Host Email', blank=True)),
                ('host_fname', models.CharField(max_length=255, verbose_name=b'Host First Name', blank=True)),
                ('host_lname', models.CharField(max_length=255, verbose_name=b'Host Last Name', blank=True)),
                ('host_st_address1', models.CharField(max_length=255, verbose_name=b'Host Address Line 1', blank=True)),
                ('host_st_address2', models.CharField(max_length=255, verbose_name=b'Host Address Line 2', blank=True)),
                ('trans_table_id', models.IntegerField(null=True, blank=True)),
