...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayPalIPN.host_fname'
        db.add_column(u'paypal_ipn', 'host_fname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PayPalIPN.host_lname'
        db.add_column(u'paypal_ipn', 'host_lname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PayPalIPN.host_st_address1'
        db.add_column(u'paypal_ipn', 'host_st_address1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PayPalIPN.host_st_address2'
        db.add_column(u'paypal_ipn', 'host_st_address2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayPalIPN.host_fname'
        db.delete_column(u'paypal_ipn', 'host_fname')

        # Deleting field 'PayPalIPN.host_lname'
        db.delete_column(u'paypal_ipn', 'host_lname')

        # Deleting field 'PayPalIPN.host_st_address1'
        db.delete_column(u'paypal_ipn', 'host_st_address1')

        # Deleting field 'PayPalIPN.host_st_address2'
        db.delete_column(u'paypal_ipn', 'host_st_address2')
    ...
    models = {
        u'ipn.paypalipn': {
            ...
            'host_email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'host_fname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'host_lname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'host_st_address1': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'host_st_address2': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
