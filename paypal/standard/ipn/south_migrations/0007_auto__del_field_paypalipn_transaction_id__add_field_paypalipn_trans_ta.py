...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PayPalIPN.transaction_id'
        db.delete_column(u'paypal_ipn', 'transaction_id')

        # Adding field 'PayPalIPN.trans_table_id'
        db.add_column(u'paypal_ipn', 'trans_table_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PayPalIPN.transaction_id'
        db.add_column(u'paypal_ipn', 'transaction_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PayPalIPN.trans_table_id'
        db.delete_column(u'paypal_ipn', 'trans_table_id')
    ...
    models = {
        u'ipn.paypalipn': {
            ...
            'trans_table_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
