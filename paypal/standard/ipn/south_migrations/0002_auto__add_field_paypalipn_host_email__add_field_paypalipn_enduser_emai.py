...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayPalIPN.host_email'
        db.add_column(u'paypal_ipn', 'host_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PayPalIPN.enduser_email'
        db.add_column(u'paypal_ipn', 'enduser_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayPalIPN.host_email'
        db.delete_column(u'paypal_ipn', 'host_email')

        # Deleting field 'PayPalIPN.enduser_email'
        db.delete_column(u'paypal_ipn', 'enduser_email')
    ...
    models = {
        u'ipn.paypalipn': {
            ...
            'enduser_email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
