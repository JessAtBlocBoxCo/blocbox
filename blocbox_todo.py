...
2. what does the messages settings page entail?

3.there is this weird thing on the basewaitlist site where if you make the page horizontally smaller the 'stop missing you rpackages' text becomes
 mis-aligned -- it has something to do with the combination of how you're styling the h1/h2 classes- with padding-left and padding-right and the margin properties
 though i'm not actually sure. its confusing.
