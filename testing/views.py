...
def facebook(request):
    ...
    if request.is_ajax():
        ...
        if enduser.is_authenticated():
            ...
            if request.POST["facebook_gender"]:
                user.facebook_gender = request.POST["facebook_gender"]
            if request.POST["facebook_locale"]:
                user.facebook_locale = request.POST["facebook_locale"]
            if request.POST["facebook_link"]:
                user.facebook_link = request.POST["facebook_link"]
            if request.POST["facebook_first_name"]:
                user.facebook_first_name = request.POST["facebook_first_name"]
            if request.POST["facebook_last_name"]:
                user.facebook_last_name = request.POST["facebook_last_name"]
            if request.POST["facebook_email"]:
                user.facebook_email = request.POST["facebook_email"]
            if request.POST["facebook_response_all"]:
                user.facebook_response_all = request.POST["facebook_response_all"]
            user.save()
