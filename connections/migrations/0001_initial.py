...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'connections_connection', (
            ...
            ('intro_message', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True)),
            ('pickup_time', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('testfield', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'connections', ['Connection'])

        # Adding unique constraint on 'Connection', fields ['host_user', 'end_user']
        db.create_unique(u'connections_connection', ['host_user_id', 'end_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Connection', fields ['host_user', 'end_user']
        db.delete_unique(u'connections_connection', ['host_user_id', 'end_user_id'])

        # Deleting model 'Connection'
        db.delete_table(u'connections_connection')
