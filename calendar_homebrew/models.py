...
class HostConflicts(models.Model):
    ...
    thismonthday1  = models.BooleanField(blank=True, null=True)
    thismonthday2  = models.BooleanField(blank=True, null=True)
    thismonthday3  = models.BooleanField(blank=True, null=True)
    thismonthday4  = models.BooleanField(blank=True, null=True)
    thismonthday5  = models.BooleanField(blank=True, null=True)
    thismonthday6  = models.BooleanField(blank=True, null=True)
    thismonthday7  = models.BooleanField(blank=True, null=True)
    thismonthday8  = models.BooleanField(blank=True, null=True)
    thismonthday9  = models.BooleanField(blank=True, null=True)
    thismonthday10 = models.BooleanField(blank=True, null=True)
    thismonthday11 = models.BooleanField(blank=True, null=True)
    thismonthday12 = models.BooleanField(blank=True, null=True)
    thismonthday13 = models.BooleanField(blank=True, null=True)
    thismonthday14 = models.BooleanField(blank=True, null=True)
    thismonthday15 = models.BooleanField(blank=True, null=True)
    thismonthday16 = models.BooleanField(blank=True, null=True)
    thismonthday17 = models.BooleanField(blank=True, null=True)
    thismonthday18 = models.BooleanField(blank=True, null=True)
    thismonthday19 = models.BooleanField(blank=True, null=True)
    thismonthday20 = models.BooleanField(blank=True, null=True)
    thismonthday21 = models.BooleanField(blank=True, null=True)
    thismonthday22 = models.BooleanField(blank=True, null=True)
    thismonthday23 = models.BooleanField(blank=True, null=True)
    thismonthday24 = models.BooleanField(blank=True, null=True)
    thismonthday25 = models.BooleanField(blank=True, null=True)
    thismonthday26 = models.BooleanField(blank=True, null=True)
    thismonthday27 = models.BooleanField(blank=True, null=True)
    thismonthday28 = models.BooleanField(blank=True, null=True)
    thismonthday29 = models.BooleanField(blank=True, null=True)
    thismonthday30 = models.BooleanField(blank=True, null=True)
    thismonthday31 = models.BooleanField(blank=True, null=True)
    nextmonthday1  = models.BooleanField(blank=True, null=True)
    nextmonthday2  = models.BooleanField(blank=True, null=True)
    nextmonthday3  = models.BooleanField(blank=True, null=True)
    nextmonthday4  = models.BooleanField(blank=True, null=True)
    nextmonthday5  = models.BooleanField(blank=True, null=True)
    nextmonthday6  = models.BooleanField(blank=True, null=True)
    nextmonthday7  = models.BooleanField(blank=True, null=True)
    nextmonthday8  = models.BooleanField(blank=True, null=True)
    nextmonthday9  = models.BooleanField(blank=True, null=True)
    nextmonthday10 = models.BooleanField(blank=True, null=True)
    nextmonthday11 = models.BooleanField(blank=True, null=True)
    nextmonthday12 = models.BooleanField(blank=True, null=True)
    nextmonthday13 = models.BooleanField(blank=True, null=True)
    nextmonthday14 = models.BooleanField(blank=True, null=True)
    nextmonthday15 = models.BooleanField(blank=True, null=True)
    nextmonthday16 = models.BooleanField(blank=True, null=True)
    nextmonthday17 = models.BooleanField(blank=True, null=True)
    nextmonthday18 = models.BooleanField(blank=True, null=True)
    nextmonthday19 = models.BooleanField(blank=True, null=True)
    nextmonthday20 = models.BooleanField(blank=True, null=True)
    nextmonthday21 = models.BooleanField(blank=True, null=True)
    nextmonthday22 = models.BooleanField(blank=True, null=True)
    nextmonthday23 = models.BooleanField(blank=True, null=True)
    nextmonthday24 = models.BooleanField(blank=True, null=True)
    nextmonthday25 = models.BooleanField(blank=True, null=True)
    nextmonthday26 = models.BooleanField(blank=True, null=True)
    nextmonthday27 = models.BooleanField(blank=True, null=True)
    nextmonthday28 = models.BooleanField(blank=True, null=True)
    nextmonthday29 = models.BooleanField(blank=True, null=True)
    nextmonthday30 = models.BooleanField(blank=True, null=True)
    nextmonthday31 = models.BooleanField(blank=True, null=True)
