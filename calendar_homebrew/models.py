...
def HostConflicts(models.Model):
    ...
    thismonthday3  = forms.BooleanField(required=False)
    thismonthday4  = forms.BooleanField(required=False)
    thismonthday5  = forms.BooleanField(required=False)
    thismonthday6  = forms.BooleanField(required=False)
    thismonthday7  = forms.BooleanField(required=False)
    thismonthday8  = forms.BooleanField(required=False)
    thismonthday9  = forms.BooleanField(required=False)
    thismonthday10 = forms.BooleanField(required=False)
    thismonthday11 = forms.BooleanField(required=False)
    thismonthday12 = forms.BooleanField(required=False)
    thismonthday13 = forms.BooleanField(required=False)
    thismonthday14 = forms.BooleanField(required=False)
    thismonthday15 = forms.BooleanField(required=False)
    thismonthday16 = forms.BooleanField(required=False)
    thismonthday17 = forms.BooleanField(required=False)
    thismonthday18 = forms.BooleanField(required=False)
    thismonthday19 = forms.BooleanField(required=False)
    thismonthday20 = forms.BooleanField(required=False)
    thismonthday21 = forms.BooleanField(required=False)
    thismonthday22 = forms.BooleanField(required=False)
    thismonthday23 = forms.BooleanField(required=False)
    thismonthday24 = forms.BooleanField(required=False)
    thismonthday25 = forms.BooleanField(required=False)
    thismonthday26 = forms.BooleanField(required=False)
    thismonthday27 = forms.BooleanField(required=False)
    thismonthday28 = forms.BooleanField(required=False)
    thismonthday29 = forms.BooleanField(required=False)
    thismonthday30 = forms.BooleanField(required=False)
    thismonthday31 = forms.BooleanField(required=False)
    nextmonthday1  = forms.BooleanField(required=False)
    nextmonthday2  = forms.BooleanField(required=False)
    nextmonthday3  = forms.BooleanField(required=False)
    nextmonthday4  = forms.BooleanField(required=False)
    nextmonthday5  = forms.BooleanField(required=False)
    nextmonthday6  = forms.BooleanField(required=False)
    nextmonthday7  = forms.BooleanField(required=False)
    nextmonthday8  = forms.BooleanField(required=False)
    nextmonthday9  = forms.BooleanField(required=False)
    nextmonthday10 = forms.BooleanField(required=False)
    nextmonthday11 = forms.BooleanField(required=False)
    nextmonthday12 = forms.BooleanField(required=False)
    nextmonthday13 = forms.BooleanField(required=False)
    nextmonthday14 = forms.BooleanField(required=False)
    nextmonthday15 = forms.BooleanField(required=False)
    nextmonthday16 = forms.BooleanField(required=False)
    nextmonthday17 = forms.BooleanField(required=False)
    nextmonthday18 = forms.BooleanField(required=False)
    nextmonthday19 = forms.BooleanField(required=False)
    nextmonthday20 = forms.BooleanField(required=False)
    nextmonthday21 = forms.BooleanField(required=False)
    nextmonthday22 = forms.BooleanField(required=False)
    nextmonthday23 = forms.BooleanField(required=False)
    nextmonthday24 = forms.BooleanField(required=False)
    nextmonthday25 = forms.BooleanField(required=False)
    nextmonthday26 = forms.BooleanField(required=False)
    nextmonthday27 = forms.BooleanField(required=False)
    nextmonthday28 = forms.BooleanField(required=False)
    nextmonthday29 = forms.BooleanField(required=False)
    nextmonthday30 = forms.BooleanField(required=False)
    nextmonthday31 = forms.BooleanField(required=False)
