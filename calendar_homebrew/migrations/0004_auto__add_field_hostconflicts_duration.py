...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostConflicts.duration'
        db.add_column(u'calendar_homebrew_hostconflicts', 'duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostConflicts.duration'
        db.delete_column(u'calendar_homebrew_hostconflicts', 'duration')
    ...
    models = {
        u'calendar_homebrew.hostconflicts': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 17, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        u'calendar_homebrew.hostweeklydefaultschedule': {
            ...
            'date_last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 17, 0, 0)', 'null': 'True', 'blank': 'True'}),
