...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostWeeklyDefaultSchedule.host_email'
        db.add_column(u'calendar_homebrew_hostweeklydefaultschedule', 'host_email',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HostConflicts.host_email'
        db.add_column(u'calendar_homebrew_hostconflicts', 'host_email',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostWeeklyDefaultSchedule.host_email'
        db.delete_column(u'calendar_homebrew_hostweeklydefaultschedule', 'host_email')

        # Deleting field 'HostConflicts.host_email'
        db.delete_column(u'calendar_homebrew_hostconflicts', 'host_email')
    ...
    models = {
        u'calendar_homebrew.hostconflicts': {
            ...
            'host_email': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
